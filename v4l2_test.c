 ...
 *
 * 25 Jul 2009  0.25 Test cases added for VIDIOC_G_ENC_INDEX
...
static CU_TestInfo suite_get_set_try[] = {
  ...
  { "VIDIOC_G_ENC_INDEX", test_VIDIOC_G_ENC_INDEX },
...
static CU_TestInfo suite_null_readonly[] = {
  ...
  { "VIDIOC_G_ENC_INDEX with NULL parameter", test_VIDIOC_G_ENC_INDEX_NULL },
